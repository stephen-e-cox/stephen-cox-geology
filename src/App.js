...
const CV = () => (
  <div className="container py-5">
    ...
    <p>Download my full CV <a href="/Stephen_Cox_CV.pdf" target="_blank" rel="noopener noreferrer">here</a>.</p>
  </div>
);
...
const CodeLinks = () => (
  <div className="container py-5">
    <h2>Code Projects</h2>
    <ul>
      <li><a href="https://massspec.academy/" target="_blank" rel="noopener noreferrer">Mass Spec Academy</a></li>
      <li><a href="https://github.com/stephen-e-cox/pyneon" target="_blank" rel="noopener noreferrer">Neon data reduction software for geochronology</a></li>
    </ul>
  </div>
);
...
const Navbar = () => (
  <nav className="navbar navbar-expand-lg navbar-light bg-light">
    <div className="container">
      <Link className="navbar-brand" to="/">Stephen E. Cox</Link>
      <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav">
        <span className="navbar-toggler-icon"></span>
      </button>
      <div className="collapse navbar-collapse" id="navbarNav">
        <ul className="navbar-nav ms-auto">
          <li className="nav-item"><Link className="nav-link" to="/bio">Bio</Link></li>
          <li className="nav-item"><Link className="nav-link" to="/cv">CV</Link></li>
          ...
          <li className="nav-item"><Link className="nav-link" to="/code">Code</Link></li>
        </ul>
      </div>
    </div>
  </nav>
